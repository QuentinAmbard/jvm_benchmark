...
class TestJVM extends Simulation {
  ...
  val cities = (0 to 100000).map(_ => getRandomStr(10+random.nextInt(10))).toArray
  val addresses = (0 to 100000).map(_ => getRandomStr(20+random.nextInt(50))).toArray
  val zipcodes = (0 to 100000).map(_ => getRandomStr(7)).toArray
  val contents = (0 to 10000).map(_ => getRandomStr(2000+random.nextInt(500))).toArray
  val smallContents = (0 to 100000).map(i => {
